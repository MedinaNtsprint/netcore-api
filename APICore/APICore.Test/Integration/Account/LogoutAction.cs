...
namespace APICore.Tests.Integration.Account
{
    ...
    public async Task SuccessfullyLogoutShouldReturnOk()
        {
            // ARRANGE
            ...
            // ACT
            var taskResult = (OkResult)await accountController.Logout();
    ...
    public async Task WrongUserLogoutShouldReturnNotFoundException()
        {
            // ARRANGE
            var fakeClaims = new List<Claim>()
            {
            ...
            // ACT
            await Assert.ThrowsAsync<APICore.Services.Exceptions.UserNotFoundException>(() => accountController.GlobalLogout());
        }

    [Fact(DisplayName = "Successfully Global Logout Should Return Ok Status Code (200)")]
    public async Task SuccessfullyGlobalLogoutShouldReturnOk()
        {
            // ARRANGE
            var fakeClaims = new List<Claim>()
            {
            ...
            // ACT
            var taskResult = (OkResult)await accountController.GlobalLogout();
    ...
    public async Task WrongUserGlobalLogoutShouldReturnNotFoundException()
        {
            // ARRANGE
            var fakeClaims = new List<Claim>()
            {
